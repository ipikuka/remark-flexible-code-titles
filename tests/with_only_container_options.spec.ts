...
`;
    ...
    const expected = `<vid class="remark-code-wrapper"><pre><code>const a = 1;
</code></pre></vid>`;
...
`;
    ...
    const expected = `<vid class="remark-code-wrapper" data-language="js"><pre><code class="language-js">const a = 1;
</code></pre></vid>`;
...
`;
    ...
    const expected = `<vid class="remark-code-wrapper" title="title.js"><pre><code>const a = 1;
</code></pre></vid>`;
...
`;
    ...
    const expected = `<vid class="remark-code-wrapper" data-language="js" title="title.js"><pre><code class="language-js">const a = 1;
</code></pre></vid>`;
...
`;
    ...
    */
    ...
    const expected = `<vid class="remark-code-wrapper" data-language="ts"><pre><code class="language-ts">const a = 1;
</code></pre></vid>`;
...
`;
    ...
    */
    ...
    const expected = `<vid class="remark-code-wrapper" data-language="typescript" title="title"><pre><code class="language-typescript">const a = 1;
</code></pre></vid>`;
