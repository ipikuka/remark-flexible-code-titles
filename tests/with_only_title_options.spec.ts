...
`;
    ...
    const expected = `<vid class="my-special-classname" title="title.js">title.js</vid>
<pre><code>const a = 1;
</code></pre>`;
...
`;
    ...
    const expected = `<vid class="my-special-classname" data-language="js" title="title.js">title.js</vid>
...
`;
    ...
    */
    ...
    const expected = `<vid class="my-special-classname" data-language="typescript" title="title">title</vid>
