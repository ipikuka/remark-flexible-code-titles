...
describe("remark-flexible-code-title, no options, meaningly with container and title by default", () => {
  /** */
...
`;
    ...
    const expected = `<div class="remark-code-container"><pre><code>const a = 1;
</code></pre></div>`;
...
`;
    ...
    const expected = `<div class="remark-code-container"><pre><code class="language-js">const a = 1;
</code></pre></div>`;
...
`;
    ...
    const expected = `<div class="remark-code-container"><div class="remark-code-title">title.js</div><pre><code>const a = 1;
</code></pre></div>`;
...
`;
    ...
    const expected = `<div class="remark-code-container"><div class="remark-code-title">title.js</div><pre><code class="language-js">const a = 1;
</code></pre></div>`;
...
`;
    ...
    */
    ...
    const expected = `<div class="remark-code-container"><pre><code class="language-ts">const a = 1;
</code></pre></div>`;
...
`;
    ...
    */
    ...
    const expected = `<div class="remark-code-container"><div class="remark-code-title">title</div><pre><code class="language-typescript">const a = 1;
</code></pre></div>`;
